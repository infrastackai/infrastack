---
title: Deploy your Next.js application with OpenTelemetry to Vercel with infrastack.ai
description: 'Learn how to deploy your Next.js application with OpenTelemetry to Vercel with infrastack.ai'
og:site_name: "infrastack.ai"
og:title: "Deploy your Next.js application with OpenTelemetry to Vercel with infrastack.ai"
og:description: "Learn how to deploy your Next.js application with OpenTelemetry to Vercel with infrastack.ai"
og:locale: "en_US"
article:publisher: "https://www.linkedin.com/company/infrastack-ai"
twitter:title: "Deploy your Next.js application with OpenTelemetry to Vercel with infrastack.ai"
twitter:description: "Learn how to deploy your Next.js application with OpenTelemetry to Vercel with infrastack.ai"
twitter:site: "@infrastackai"
---
import { GithubIcon, JsIcon, VercelIcon } from '/snippets/custom-icons.mdx'
